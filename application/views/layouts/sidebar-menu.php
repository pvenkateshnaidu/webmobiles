  ...
  <body>
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        <a href="<?= site_url('Dashboard'); ?>" class="br-menu-link <?php if($this->uri->segment(2)==""){echo "active";}?>">
          <div class="br-menu-item">
            <i class="menu-item-icon icon fa fa-dashboard tx-18-force"></i>
            <span class="menu-item-label">Dashboard</span>
          </div><!-- menu-item -->
        </a><!-- br-menu-link -->
		<a href="<?= site_url('Dashboard/addNewCollege'); ?>" class="br-menu-link <?php if($this->uri->segment(2)=="addNewCollege"){echo "active";}?>">
          <div class="br-menu-item">
            <i class="menu-item-icon icon fa fa-plus tx-18-force"></i>
            <span class="menu-item-label">Add New College</span>
          </div><!-- menu-item -->
        </a><!-- br-menu-link -->
		<a href="<?= site_url('Dashboard/collegelist'); ?>" class="br-menu-link <?php if($this->uri->segment(2)=="collegelist"){echo "active";}?>">
          <div class="br-menu-item">
            <i class="menu-item-icon icon fa fa-building-o tx-18-force"></i>
            <span class="menu-item-label">All Colleges</span>
          </div><!-- menu-item -->
        </a><!-- br-menu-link -->
        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name hidden-md-down"><?php echo $this->session->userdata('uName'); ?></span>
            ...
            <div class="dropdown-menu dropdown-menu-header wd-200">
              <ul class="list-unstyled user-profile-nav">
                ...
                <li><a href="<?= site_url('User/logOut'); ?>"><i class="icon ion-power"></i> Sign Out</a></li>
              </ul>
            </div><!-- dropdown-menu -->
          </div><!-- dropdown -->
        </nav>
