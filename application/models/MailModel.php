...
class MailModel extends CI_Model {
    ...
    private function noReplyCredentials() {
        $this->from = "info@ushodhayamatrimonial.com";
        $this->SmtpUser = base64_encode("info@ushodhayamatrimonial.com");
        $this->SmtpPass = base64_encode("Usho@info");
    }

    protected  function SendMail($to, $subject, $body, $reply = '') {
        ...
        if ($SMTPIN = fsockopen($this->SmtpServer, $this->PortSMTP)) {
            ...
            $headers .= "From: ushodhayamatrimonial.com <" . $this->from . ">" . $this->newLine;
            $headers .= "To: " . $this->to . " <" . $this->to . ">" . $this->newLine;
            $headers .= "Bcc: ushodhayamatrimonial.com <info@ushodhayamatrimonial.com>" . $this->newLine;
    ...
    function forgotPassword($param) {
        $body = $this->load->view('mails/forgot-password', $param, TRUE);
        $subject = "New Password for Login- ushodhayamatrimonial.com";
        $to = $param['to'];
    ...
    function sendVoucher($param) {
        ...
        $subject = "Your booking Invoice - ".$param['requestDetails']->transId." - ushodhayamatrimonial.com";
    ...
    function sendNewUser($param) {
        $body = $this->load->view('mail/mail-voucher', $param, TRUE);
        $subject = "Thank you for Registering with Ushodhaya Matrimonial.Com ..Keep Secure Your Credentials - ushodhayamatrimonial.com";
